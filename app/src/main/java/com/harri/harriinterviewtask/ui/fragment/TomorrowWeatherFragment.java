...
public class TomorrowWeatherFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mDate = view.findViewById(R.id.tomorrow_weather_date);
        mWeatherTemp = view.findViewById(R.id.tomorrow_weather_temp);
        mWeatherPressure = view.findViewById(R.id.tomorrow_weather_pressure);
        mWeatherHumidity = view.findViewById(R.id.tomorrow_weather_humidity);

        return view;
    }

    public void update(Weather weather) {
        WeatherList weatherList = weather.getList().get(1);
